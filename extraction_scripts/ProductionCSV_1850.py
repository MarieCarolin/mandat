...
Pages_sans_text = ['AEV_3090_1850_St-Maurice_Evionnaz_002.xml', 'AEV_3090_1850_St-Maurice_Evionnaz_Rasse_001.xml', 'AEV_3090_1850_St-Maurice_Evionnaz_Rasse_002.xml', 'AEV_3090_1850_St-Maurice_Verossaz_Bassays_002.xml'] #lst de pages sans texte 
...
# Partie 2 - Restitution des prénoms composés dans la colonne Prénom
            ...
            if xml_file_name == "AEV_3090_1850_Sion_Sion_002.xml":
                Premiere_Partie = [('-', 553, 3182)]
            
            if xml_file_name == 'AEV_3090_1850_St-Maurice_Dorenaz_002.xml':
                Premiere_Partie = [('-', 526, 3179)]
...
# Partie 3 - Restitution du lien entre Prénom et Nom de Famille 
            ...
            if xml_file_name == "AEV_3090_1850_Conthey_Ardon_002.xml":
                FirstName_str = [('?',103,2437),('?',306,2742),('?',321,3244),('?',427,2742),('?',1320,2825),('?',1320,2825),('?',1320,3022),('François',1545,2757),('Florantin',1816,2791),('Ignace',2075,2781),('Benjamain',2366,2776),('Modeste',2640,2810),('Marie',2909,2781),('Margueritte',3188,2820),('Joseph',3465,2800),('Magdelaine',3751,2805),('Marie',3994,2805)]
            
            if xml_file_name == "AEV_3090_1850_Monthey_Vouvry_002.xml":
                FirstName_str = LastName_str

            if xml_file_name == 'AEV_3090_1850_St-Maurice_Evionnaz_Balmaz_002.xml':
                LastName_str = [('Coquoz', 2086, 2645)]
                FirstName_str = [('François Frédéric', 2086, 2645)]

            if xml_file_name == 'AEV_3090_1850_Raron_Blatten_007.xml':
                FirstName_str = [('Joseph', 2737, 3043)]
                LastName_str = [('Kalbormnaten', 2727, 2402)]

            if xml_file_name == 'AEV_3090_1850_Raron_Niedergesteln_002.xml':
                LastName_str = []
                FirstName_str = []
               
            if xml_file_name in ["AEV_3090_1850_Goms_Ausserbinn_004.xml", "AEV_3090_1850_Goms_Lax_002.xml", "AEV_3090_1850_Leuk_Varen_002.xml" ] : 
                LastName_str = []
            
            if xml_file_name == 'AEV_3090_1850_St-Maurice_Massongex_002.xml':
                LastName_str = [('Favre', 2067, 2476), ('Dave', 2138, 2481)]
                FirstName_str = [('André', 2004, 3092)  , ('Maurice', 2193, 3087)]

            if xml_file_name == 'AEV_3090_1850_St-Maurice_Mex_002.xml':
                LastName_str = [('Richard', 2310, 2777)]
                FirstName_str = [('François', 2310, 2777)]

            if xml_file_name == 'AEV_3090_1850_St-Maurice_St-Maurice_Epinassey_002.xml':
                LastName_str = [('Reynaud', 1931, 2699)]
                FirstName_str = [('François Joseph', 1931, 2699)]

            if xml_file_name == 'AEV_3090_1850_St-Maurice_Verossaz_Haussays_002.xml':
                LastName_str = [('Dubulluit', 2111, 3131),('Money', 2449, 3121),('Gerl', 2659, 3104)]
                FirstName_str = [('Maurice', 2111, 3131),('Jean Louis', 2449, 3121),('Jean Louis', 2659, 3104)]
            
            if len(LastName_str) == 0 and len(FirstName_str) == 0:
                pass
...
# Partie 5 - Transformation des données en fichier CSV 
output_forCSV =[]
for xml in output_list:
    for line in xml:
...
with open("Output1850.csv", "w", newline='',encoding='utf-8') as csv_file:
