...
xml_folder =  r'Test_1870/Valais1870'
destination_folder = r'Test_1870/Transcriptions'

# Créer le nouveau dossier "Set_2" s'il n'existe pas
nouveau_dossier = os.path.join(destination_folder, 'Set_2')
if not os.path.exists(nouveau_dossier):
    os.makedirs(nouveau_dossier)

# Nombre de fichiers à sélectionner
nombre_fichiers_a_selectionner = 50
